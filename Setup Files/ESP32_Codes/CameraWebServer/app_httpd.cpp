...
void startCameraServer() {
  ...
  // config.max_open_sockets = 5;  // add this line //k9
  // config.server_port = 80;//k9
  config.max_uri_handlers = 16;
  // httpd_config_t config1 = HTTPD_DEFAULT_CONFIG();//k9
  // config1.max_open_sockets = 5;    // ← add here too, port 81 is the stream!//k9
  // config1.server_port = 81;//k9
  // config1.ctrl_port = 32769;//k9
